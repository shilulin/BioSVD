...
class SVD_Pipeline(StableVideoDiffusionPipeline):
    # using designed encoder_hidden
    @torch.no_grad()
    def __call__(
        self,
        ...
        # do_classifier_free_guidance: True --> torch.Size([2, 1, 1024])   False --> torch.Size([1, 1, 1024])
